...
class Confidentiality extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final Color sectionBackgroundColor = isDarkMode ? Colors.grey[800]! : Colors.grey[100]!;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSectionHeader('1. Collecte des informations personnelles', Icons.person_add, textColor),
          SizedBox(height: 20),
          ...
          SizedBox(height: 20),
          _buildSectionHeader('2. Utilisation des informations', Icons.info, textColor),
          SizedBox(height: 20),
          _buildSectionContent(
          ...
          SizedBox(height: 20),
          _buildSectionHeader('3. Sécurité des informations', Icons.security, textColor),
          SizedBox(height: 20),
          _buildSectionContent(
          ...
          SizedBox(height: 20),
          _buildSectionHeader('5. Partage des informations', Icons.share, textColor),
          SizedBox(height: 20),
          _buildSectionContent(
          ...
          SizedBox(height: 20),
          _buildSectionHeader('6. Modifications de la politique de confidentialité', Icons.update, textColor),
          SizedBox(height: 20),
          _buildSectionContent(
          ...
          SizedBox(height: 20),
          _buildSectionHeader('7. Contactez-nous', Icons.contact_mail, textColor),
          SizedBox(height: 20),
          _buildSectionContent(
  ...
  Widget _buildSection(String content, IconData icon, Color textColor, Color backgroundColor) {
    return Container(
