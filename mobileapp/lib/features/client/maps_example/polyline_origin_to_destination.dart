...
import 'package:mobileapp/features/client/maps_example/location_provider.dart';
  ...
  Widget build(BuildContext context) {
    final polylineTwoPointRoute = ref.watch(
      polylineTwoPointsProvider(
        RouteParams(origin: _pointA, destination: _marketPos),
      ),
    );

    final distanceInMetters = ref.watch(
      distanceInMetersProvider(
        DistanceParams(origin: _pointA, destination: _marketPos),
      ),
    );
